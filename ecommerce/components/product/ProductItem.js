            ...
            <div className="col-lg-4 col-md-6 mt-5 p-3 col-12">
            {
                ...
                <div className="single-product">
                    <div className="product-img">
                        <>
                            <a>
                            <img className="default-img" style={{width: "100%", height: "300px"}} src={product.images[0].url} alt="#" />
                            <img className="hover-img" style={{width: "100%", height: "300px"}} src={product.images[0].url} alt="#" />
                            <span>
                            {
                                product.inStock > 0
                                ? 
                    ...
                    <div className="product-content pl-3">
                        <h3 className='text-capitalize'><Link href={`product/${product._id}`}>{product.title}</Link></h3>
