...
const Register = (props) => {
  ...
  const handleSubmit = async e => {
    ...
    const res = await postData('auth/register', {name: fullName, email, password, cf_password})
					...
					<div className="col-12">
						<div className="bread-inner">
							<ul className="bread-list">
								...
								<li className="active"><Link href="/register">Register</Link></li>
							</ul>
						</div>
					</div>
				</div>
								...
								<div className="row">
									<div className="col-6">
										<div className="form-group">
											...
											<input type="text" name="firstName" value={firstName} onChange={handleChangeInput} />
										</div>
									</div>
									<div className="col-6">
										<div className="form-group">
											<label>Your Last Name<span>*</span></label>
											<input type="text" name="lastName" value={lastName} onChange={handleChangeInput} />
										</div>
									</div>
									<div className="col-12">
										<div className="form-group">
                      ...
                      <small id="emailHelp" className="form-text text-muted">We'll never share your email with anyone else.</small>
									...
									<div className="col-12">
										<div className="form-group">
											...
											<input type={passwordShown ? "text" : "password"} className='pr-5' name="password" value={password} onChange={handleChangeInput} />
									...
									<div className="col-12">
										<div className="form-group">
											...
											<input type={confirmpasswordShown ? "text" : "password"} name="cf_password" value={cf_password} onChange={handleChangeInput}
											className='pr-5' />
											<span className="form__symbol">
									...
									<p>
										...
										<a href='/terms-conditions' target="_blank"><a style={{color: 'crimson'}}>Terms & Conditions</a></a>
										</small>
									</p>
									</div>
									<div className="col-12">
										...
										{terms_conditions ? (
											...
											<a style={{ float: "right"}}>Have an account ? <Link href="/signin" className="btn" ><a style={{color: 'crimson'}}>Login Now</a></Link></a>
										</div>
									</div>
								</div>
							</form>
