					...
					<div className="col-12">
						<div className="bread-inner">
							<ul className="bread-list">
								...
								<li className="active"><Link href="/create-nft">Create NFT</Link></li>
							</ul>
						</div>
					</div>
				</div>
        ...
        <div className="products_manager container">
            <form className="row">
                <div className="col-md-6">
                    <label htmlFor="title" className='mt-3'>Asset Name</label>
                    <input type="text" name="title"
                    placeholder="Asset Name" className="d-block w-100 p-2"
                    ...
                    />
                    <label htmlFor="image_upload" className="mt-3">Image Upload</label>
                    <div className="input-group">
                        <div className="input-group-prepend">
                            <span className="input-group-text">Upload</span>
                        </div>
                        <div className="custom-file border rounded">
                            <input type="file" className="custom-file-input" placeholder='Upload product image ...'
                            onChange={onChange} multiple accept="image/*" />
                        </div>
                    ...
                    placeholder="Description"  onChange={e => updateFormInput({...formInput, description: e.target.value})}
